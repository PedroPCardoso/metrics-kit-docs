---
title: Guia Completo — `nestjs-metrics`
excerpt: >-
  Gere métricas e Trends a partir de entidade typeORM, com uma API fluente e
  integração NestJS
hidden: false
---
## Sumário
...
<Callout icon="⚠️" theme="warn">
  ### O esquema é validado com Zod. Locales inválidos (ex: `''`) lançam
...
<Callout icon="⚠️" theme="warn">
  ### **SQLite** não suporta timezone no modo executor. Lança
